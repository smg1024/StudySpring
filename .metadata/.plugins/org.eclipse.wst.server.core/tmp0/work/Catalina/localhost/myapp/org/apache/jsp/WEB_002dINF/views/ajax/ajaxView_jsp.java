 ...
 * Generated at: 2022-12-19 08:40:07 UTC
...
public final class ajaxView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("\n");
      out.write("<title>ajaxView.jsp</title>\n");
      out.write("<script>\n");
      out.write("	$(function(){\n");
      out.write("		// 비동기식으로 서버에 접속하여 문자열을 결과값으로 얻어오기\n");
      out.write("		$(\"#ajaxString\").click(function(){\n");
      out.write("			var params = \"num=12&name=홍길동\";\n");
      out.write("			$.ajax({\n");
      out.write("				url:\"/myapp/ajaxString\",	// 매핑주소\n");
      out.write("				data:params,	// 서버로 보내는 데이터(parameter)\n");
      out.write("				type:\"GET\",		// 전송 방식(GET, POST)\n");
      out.write("				success:function(result){	// 서버에서 정상 응답했을 때\n");
      out.write("					// append() : 마지막에 추가\n");
      out.write("					// prepends() : 제일 앞에 추가\n");
      out.write("					$(\"#ajaxResult\").append(result);\n");
      out.write("				},error:function(e){	// 서버에서 응답받지 못했을 때\n");
      ...
      out.write("					username:\"세종대왕\",\n");
      out.write("					tel:\"010-9701-5637\",\n");
      out.write("					age:25\n");
      out.write("			};\n");
      out.write("			var url = \"/myapp/ajaxObject\";\n");
      out.write("			\n");
      out.write("			$.ajax({\n");
      out.write("				url:url,\n");
      ...
      out.write("					tag += \"<li>번호 : \" + result.postno + \"</li>\";\n");
      out.write("					tag += \"<li>제목 : \" + result.subject + \"</li>\";\n");
      out.write("					tag += \"<li>작성자 : \" + result.username + \"</li>\";\n");
      out.write("					tag += \"</ol>\";\n");
      out.write("					$(\"#ajaxResult\").append(tag);\n");
      ...
      out.write("		});\n");
      out.write("		\n");
      out.write("		// 비동기식으로 서버에 접속하여 List받아오기\n");
      out.write("		$(\"#ajaxList\").click(function(){\n");
      out.write("			\n");
      out.write("			$.ajax({\n");
      out.write("				url:\"/myapp/ajaxList\",\n");
      out.write("				data:{nowPage:2},\n");
      out.write("				type:\"GET\",\n");
      out.write("				success:function(result){\n");
      out.write("					// console.log(result);\n");
      out.write("					// List의 객체를 순차적으로 접근하기 위해서 $(result)한다\n");
      out.write("					var $result = $(result);\n");
      out.write("					var tag = \"<ul>\";\n");
      out.write("					\n");
      out.write("					$result.each(function(idx, obj){\n");
      out.write("						tag += \"<li>\" + obj.postno + \"</li>\";\n");
      out.write("						tag += \"<li>\" + obj.subject + \"</li>\";\n");
      out.write("						tag += \"<li>\" + obj.regdate + \"</li>\";\n");
      out.write("					});\n");
      out.write("					tag += \"</ul>\";\n");
      out.write("					\n");
      out.write("					$(\"#ajaxResult\").append(tag);\n");
      ...
      out.write("	<h1>AJAX : 동기식, 비동기식으로 요청처리</h1>\n");
      out.write("	<pre>\n");
      out.write("		pom.xml에서 gson프레임워크 추가\n");
      out.write("	</pre>\n");
      out.write("	<div>\n");
      out.write("		<input type=\"button\" value=\"String\" id=\"ajaxString\">\n");
      out.write("		<input type=\"button\" value=\"Object\" id=\"ajaxObject\">\n");
      out.write("		<input type=\"button\" value=\"List\" id=\"ajaxList\">\n");
      out.write("	</div>\n");
